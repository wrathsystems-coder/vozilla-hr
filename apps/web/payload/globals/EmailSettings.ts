      ...
      fields: [
        {
          ...
          options: [
            ...
            { label: "Lead → partner", value: "lead-to-dealer" },
            ...
            { label: "Reset lozinke partnera", value: "dealer-password-reset" },
            { label: "Admin: novi lead", value: "admin-new-lead-notification" },
            { label: "Admin: novi GDPR zahtjev", value: "admin-new-gdpr-notification" },
            { label: "Partner reminder #1 (24h)", value: "dealer-reminder-1" },
            { label: "Partner reminder #2 (48h)", value: "dealer-reminder-2" },
